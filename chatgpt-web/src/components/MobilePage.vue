        ...
        <el-container>
            <el-main>
                <el-row>
                    ...
                    <el-col :span="22"><el-form label-width="auto" size="large">
                    ...
                    <el-list-item v-for="(chat, index) in chatList" :key="index">
                        ...
                        <template v-if="chat.from === 'self'">
                            <el-row :gutter="8" justify="end" style="margin-top: 15px;">
                                ...
                                <el-card>
                                    <span style="white-space: pre-wrap; margin-right: 4px;">{{ chat.text }}</span>
                                </el-card>
                        ...
                        <template v-else>
                            <el-row :gutter="8" justify="start" style="margin-top: 15px;">
                                ...
                                <el-card>
                                    <span style="white-space: pre-wrap; margin-left: 4px;">{{ chat.text }}</span>
                                </el-card>
